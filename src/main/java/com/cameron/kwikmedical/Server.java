...
public class Server {
    public static void main(String[] args) {
        ...
        try
        {
            ...
            DataInputStream messages = new DataInputStream(sock.getInputStream());
            ...
            while ((line = messages.readUTF()) != null) {
                System.out.println(line);
                // Send message back to client
                //String messageUpperCase = toUpper(line);
                //network.writeUTF(messageUpperCase);
            }
